                ...
                <div className="bg-card rounded-2xl border-standard shadow-xl overflow-hidden">
                    <div className="p-8 md:p-10">
                        ...
                        <div className="text-center mb-10">
                            <h2 className="!text-4xl !mb-2 !text-left md:!text-center leading-tight">Welcome <span className="not-italic">Back!</span></h2>
                            <p className="text-text-body font-medium opacity-70 text-sm">Login to continue to ClubSphere</p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-8">
                            {[
                                ...
                                { role: 'manager', icon: FiShield, label: 'Manager', color: 'secondary' },
                                { role: 'admin', icon: FiLock, label: 'Admin', color: 'primary' }
                            ].map((item) => (
                                <button 
                                    key={item.role}
                                    type="button"
                                ...
                                >
                                    <item.icon className={`text-${item.color} group-hover:scale-110 transition-transform`} size={18} />
                                    <span className="text-[9px] font-black uppercase tracking-widest text-text-heading/70">{item.label} Demo</span>
                                </button>
                            ))}
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input
                                    ...
                                    className={`input-field-custom ${errors.email ? 'border-red-500 focus:border-red-500' : ''}`}
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className={`input-field-custom w-full pr-12 ${errors.password ? 'border-red-500 focus:border-red-500' : ''}`}
                        ...
                        <p className="text-center mt-10 text-sm font-bold text-text-body/60">
                            New to ClubSphere?{' '}
                            <Link to="/register" className="text-primary hover:underline underline-offset-4 decoration-2 transition-all">
                                Create Account
                            </Link>
                        </p>
                    </div>
