...
const ClubMembers = () => {
    ...
    return (
        <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Club Members Management</h1>
            <h2 className="text-xl text-indigo-600 mb-6 border-b pb-2">Club: {clubName || 'N/A'} ({members.length} Members)</h2>
