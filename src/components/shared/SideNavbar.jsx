...
const SideNavbar = () => {
    ...
    return (
        <nav className="space-y-2">
            ...
            <h3 className="text-xs font-semibold uppercase text-[var(--color-text-muted)] mt-4 pt-4 border-t border-gray-200">General</h3>
            ...
            {(isAdminOrOrganizer) && (
                <>
                    <h3 className="text-xs font-semibold uppercase text-[var(--color-text-muted)] mt-4 pt-4 border-t border-gray-200">Management</h3>
            ...
            <div className="pt-4 border-t border-gray-200 mt-4 space-y-2">
                <h3 className="text-xs font-semibold uppercase text-[var(--color-text-muted)]">Quick Actions</h3>
